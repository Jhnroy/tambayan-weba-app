    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="bg-linear-to-r from-blue-700 to-blue-500 text-white text-center py-16 px-4">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button className="bg-white text-blue-600 px-5 py-2 rounded-full font-medium hover:bg-gray-200">
            Log in
          </button>
        </div>
      </section>
        ...
        {events.map((event, index) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-xs text-gray-400 mb-2">Purok 3, Brgy. Holy Spirit, QC</p>
