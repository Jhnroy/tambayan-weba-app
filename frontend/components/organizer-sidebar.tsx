      ...
      >
        ...
        <div className="flex flex-col h-full border-r border-gray-200">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            ...
            <ul className="space-y-1">
              {navItem("/organizer/participant", <Users size={18} />, "Participants", 12)}
              {navItem("/organizer/attendance", <ClipboardCheck size={18} />, "Mark Attendance")}
            </ul>
            ...
            <ul className="space-y-1">
              {navItem("/organizer/organization-profile", <Building2 size={18} />, "Organization Profile")}
              {navItem("/organizer/notifications", <Bell size={18} />, "Notifications", 2)}
            </ul>
          </div>
